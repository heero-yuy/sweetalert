...
(function(window, document) {
  ...
  window.sweetAlert = window.swal = function() {
    ...
    switch (typeof arguments[0]) {
      ...
      case 'object':
        ...
        params.allowHTML          = arguments[0].allowHTML || params.allowHTML;
        params.waitDialog         = arguments[0].waitDialog || params.waitDialog;
      ...
      if (keyCode === 9) {
        ...
        if (keyCode === 13 || keyCode === 32) {
            if (btnIndex === -1) {
              ...
              $targetElement = $okButton;
              if(params.confirmButtonText == "none")
  ...
  function setParameters(params) {
    ...
    if (params.cancelButtonText) {
      $cancelBtn.innerHTML = params.allowHTML? params.cancelButtonText : escapeHtml(params.cancelButtonText);
    }
    if (params.confirmButtonText) {
      $confirmBtn.innerHTML = params.allowHTML? params.confirmButtonText : escapeHtml(params.confirmButtonText);
      $confirmBtn.style.display= params.waitDialog? "none" : "initial";
    }
  ...
  window.swalCloseModal = function() {
    var modal = getModal();
